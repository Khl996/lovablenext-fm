-- Update work_order_reject to set status to 'rejected_by_technician' when technician rejects
...
BEGIN
  ...
  IF _rejection_stage = 'technician' THEN
    -- Technician rejects -> goes to rejected_by_technician (for supervisor to see and reassign)
    _new_status := 'rejected_by_technician';
